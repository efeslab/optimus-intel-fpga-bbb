...
foreach lib [list \
	...
	echo "Creating $lib"
	vlib $::env(ASE_WORKDIR)/../../sim_libraries/$lib
	vmap $lib $::env(ASE_WORKDIR)/../../sim_libraries/$lib
}

set QUARTUS_INSTALL_DIR "/home/jcma/intelFPGA_pro/17.0/quartus/"
...
eval  vcom  "$::env(ASE_WORKDIR)/../../hw/rtl/IP/fp_mult_arria10/altera_fp_functions_160/sim/dspba_library_package.vhd" -work altera_fp_functions_160
eval  vcom  "$::env(ASE_WORKDIR)/../../hw/rtl/IP/fp_mult_arria10/altera_fp_functions_160/sim/dspba_library.vhd" -work altera_fp_functions_160
eval  vcom  "$::env(ASE_WORKDIR)/../../hw/rtl/IP/fp_mult_arria10/altera_fp_functions_160/sim/fp_mult_arria10_altera_fp_functions_160_a7kpira.vhd" -work altera_fp_functions_160
